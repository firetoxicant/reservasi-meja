...
<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <input type="text" name="nama_menu" 
                   ...
                   class="w-full px-3 py-2 border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white rounded-md focus:ring-2 focus:ring-green-500 focus:outline-none">
        </div>
    ...
    {{-- Deskripsi Menu --}}
    <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-white mb-1">Deskripsi Menu</label>
        <textarea name="deskripsi" rows="3" placeholder="Tuliskan racikan bumbu pendek atau deskripsi menu..."
                  class="w-full px-3 py-2 border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white rounded-md focus:ring-2 focus:ring-green-500 focus:outline-none">{{ old('deskripsi', $menu->deskripsi ?? '') }}</textarea>
    </div>
    ...
    <div>
        ...
        <input type="file" name="gambar" accept="image/jpeg,image/png,image/jpg" @if(!isset($menu)) required @endif
               class="w-full px-3 py-2 border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white rounded-md bg-white focus:outline-none">
