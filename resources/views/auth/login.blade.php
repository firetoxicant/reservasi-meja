...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="../../assets/img/abb.png" type="image/x-icon">
    <link
  ...
  <body>
    ...
    @endif
    <div class="flex items-center min-h-screen p-6 bg-gradient-to-b from-gray-500 to-yellow-300 dark:bg-gray-900">
      <div
            ...
            <div class="w-full">
              ...
              <form action="/postlogin" method="post">
                ...
                <label class="block text-sm">
                  ...
                  <input name="email" value="{{ request()->cookie('remember_email') }}"
                ...
                <label class="block mt-4 text-sm">
                  ...
                  <input name="password" value="{{ request()->cookie('remember_password') }}"
                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-yellow-400 focus:outline-none focus:shadow-outline-yellow dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                    placeholder="***************"
                    type="password"
                  />
                ...
                <label class="block mt-4 text-sm">
                  ...
                  <input name="remember_me" type="checkbox" {{ request()->cookie('remember_email') ? 'checked' : '' }}
                  class="p-2 form-checkbox dark:bg-gray-700  border-gray-600 focus:border-yellow-400 focus:outline-none focus:shadow-outline-yellow dark:text-gray-300 dark:focus:shadow-outline-gray">
                </label>
